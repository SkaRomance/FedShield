...
const createCompanySchema = z.object({
  ...
  activityTypesJson: z.string().nullable().optional(),
  retailScopesJson: z.string().nullable().optional(),
...
const companyOutputSchema = z.object({
  ...
  activityTypesJson: z.string().nullable(),
  retailScopesJson: z.string().nullable(),
